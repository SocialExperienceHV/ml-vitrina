...
const ACTIVIDAD = 'Actividad 2 – Gol James'
...
export default function Actividad2Page() {
  ...
  return (
    <div className="min-h-screen bg-ml-gray pb-24">
      <PageHeader
        title="Gol James"
        subtitle="Actividad 2 – Selecciona el valor del bono"
        accent="blue"
      />
      ...
      <div className="px-4 py-6 max-w-md mx-auto space-y-6">
        ...
        <div className="card">
          ...
          <input
            ...
            className="w-full border-2 border-gray-200 rounded-xl px-4 py-4 text-lg font-semibold text-ml-dark placeholder-gray-300 focus:outline-none focus:border-ml-blue transition-colors"
          />
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full btn-ml-blue text-lg py-5 rounded-2xl disabled:opacity-50 disabled:cursor-not-allowed"
        >
